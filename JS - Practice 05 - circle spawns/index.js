(() => {
    ...
    class Dot {
      ...
      draw(x, y) {
        ...
        createCircle(this.pos.x, this.pos.y, this.rad, true, this.color);// vnutrenij zalitij krug
        createCircle(this.pos.x, this.pos.y, this.rad, false, config.defColor);// vnesnij krug - obodok
      }
    }
